...
def get_graphrag_functions(api_url: str | None = None) -> list[dict[str, Any]]:
...
def get_graphrag_function_map(api_url: str | None = None) -> dict[str, Callable]:
    ...
    def graphrag_search(
        query: str, n_results: int = 5, max_hops: int = 2
    ) -> dict[str, Any]:
    ...
    def graphrag_add_document(
        text: str, title: str | None = None, source: str | None = None
    ) -> dict[str, Any]:
