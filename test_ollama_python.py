...
def test_ollama_embeddings() -> None:
    ...
    try:
        ...
        response = ollama.embeddings(
            model="snowflake-arctic-embed2", prompt="This is a test"
        )
    ...
    try:
        ...
        for text in texts:
            response = ollama.embeddings(model="snowflake-arctic-embed2", prompt=text)
