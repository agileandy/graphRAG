...
def main():
    ...
    print(f"Extracted entities: {', '.join(entity['name'] for entity in result['entities'])}")
    ...
    print("\nNext steps:")
    print("1. Try adding more documents with 'python scripts/batch_process.py --create-examples'")
    print("2. Process the example documents with 'python scripts/batch_process.py --dir ./example_docs'")
