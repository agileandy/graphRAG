...
def main() -> None:
    ...
    search_parser = subparsers.add_parser(
        "search", help="Search for documents in the GraphRAG system"
    )
    ...
    concept_parser = subparsers.add_parser(
        "concept", help="Get information about a concept"
    )
    ...
    related_parser = subparsers.add_parser(
        "related-concepts", help="Get concepts related to a given concept"
    )
    related_parser.add_argument("--name", required=True, help="Concept name")

    # Get passages about concept command
    passages_parser = subparsers.add_parser(
        "passages-about-concept", help="Get passages that mention a given concept"
    )
    ...
    books_parser = subparsers.add_parser(
        "books-by-concept", help="Get books that mention a given concept"
    )
    books_parser.add_argument("--name", required=True, help="Concept name")

    # Get documents command
    docs_parser = subparsers.add_parser(
        "documents", help="Get a list of documents in the GraphRAG system"
    )
