...
def test_concept_extraction(llm_manager: LLMManager, text_key: str = "graphrag"):
    """
...
def main():
    ...
    parser.add_argument("--text", type=str, choices=list(SAMPLE_TEXTS.keys()), default="graphrag", help="Text to use for testing")
