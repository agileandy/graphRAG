...
from src.utils.config import load_config, get_embedding_provider_config, get_reranker_provider_config
...
def test_reranker():
    ...
    try:
        ...
        documents = [
            {"text": "Machine learning is a branch of artificial intelligence.", "id": "doc1"},
            {"text": "Deep learning is a subset of machine learning.", "id": "doc2"},
            {"text": "Python is a programming language often used for data science.", "id": "doc3"},
            {"text": "Neural networks are used in deep learning applications.", "id": "doc4"},
        ...
        if reranked_docs and len(reranked_docs) > 0:
            print(f"Successfully reranked documents!")
...
def test_vector_db_reranking():
    ...
    try:
        ...
        print(f"Created vector database")
        ...
        reranked_results = vector_db.query(query_texts=[query], n_results=3, rerank=True)
