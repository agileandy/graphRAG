...
def test_search_functionality() -> bool | None:
    ...
    try:
        ...
        if success:
            ...
            if related_concepts:
                ...
                print(
                    "⚠️ No related concepts found - this might be expected for a new document"
                )
            ...
            if success:
                ...
                print(
                    f"✅ Found {len(documents)} documents for concept '{concept_to_check}'"
                )
                ...
                if documents:
                    ...
                    print(
                        "⚠️ No documents found for this concept - this might be expected"
                    )
            else:
            ...
            if success:
                print(
                    f"✅ Found alternative concept: {concept_response.get('concept', {}).get('name')}"
                )
            else:
