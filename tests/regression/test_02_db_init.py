...
def delete_chromadb():
    ...
    chroma_dir = os.environ.get("CHROMADB_DIR", os.path.expanduser("~/.graphrag/chromadb"))
...
def delete_neo4j():
    ...
    if os.path.exists(neo4j_dir):
        try:
            ...
            for file in ["neostore", "neostore.counts.db", "neostore.id", "neostore.labelscanstore.db"]:
