...
try:
    ...
    from src.vector_database.vector_database import VectorDatabase # Assuming this is the correct path for VectorDatabase
except ImportError:
    pytest.fail("Could not import database classes. Make sure the files exist and paths are correct (e.g., src.database.vector_db for VectorDatabase).")
...
@patch('src.vector_database.vector_database.chromadb.PersistentClient') # Adjust if VectorDatabase path is different
