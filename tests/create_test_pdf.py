...
# Add content
pdf.set_font("Arial", size=12)
pdf.multi_cell(0, 10, txt="This is a test PDF document for the GraphRAG system. It contains text, a table, and a simple diagram to test the advanced PDF processing capabilities.")
pdf.ln(10)
