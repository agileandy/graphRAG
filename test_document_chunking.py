...
def test_basic_chunking() -> bool:
    ...
    for size in chunk_sizes:
        ...
        chunks = smart_chunk_text(
            test_text, chunk_size=size, overlap=50, semantic_boundaries=False
        )
...
def test_semantic_chunking() -> bool:
    ...
    chunks = smart_chunk_text(
        test_text, chunk_size=200, overlap=50, semantic_boundaries=True
    )
...
def test_paragraph_preservation() -> bool:
...
def test_overlap_functionality() -> bool:
    ...
    for overlap in overlap_sizes:
        ...
        chunks = smart_chunk_text(
            test_text, chunk_size=chunk_size, overlap=overlap, semantic_boundaries=False
        )
...
def test_large_document_chunking() -> bool:
    ...
    for i in range(1, 21):
        paragraphs.append(
            f"This is paragraph {i} in the test document. It contains multiple sentences that will help test the chunking functionality. We want to ensure that the chunking works properly with larger documents and preserves the semantic meaning of the text."
        )
