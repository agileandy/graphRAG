...
def test_text_generation(llm_manager: LLMManager) -> None:
    ...
    """
    prompt = (
        "Explain the concept of Retrieval-Augmented Generation (RAG) in 3-4 sentences."
    )
...
def test_concept_extraction(llm_manager: LLMManager) -> None:
